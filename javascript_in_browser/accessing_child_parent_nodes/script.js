...
// Since the [.childNodes] returns the object of all the children of that element, so it can be used to acces all the children of the element by its index

// First child of the element   :   document.body.firstChild = document.body.childNodes[0]
// Last child of the element    :   document.body.lastChild = document.body.childNodes[document.body.childNodes.length - 1]
...
// console.log(document.body.childNodes[1].nextSibling);           // This will print the next sibling of 2nd sibling of body, i.e the 3rd child of body.
// console.log(document.body.childNodes[1].previousSibling);       // This will print the previous sibling of 2nd sibling of body, i.e the 1st child of body.
...
// Here both of the above statements will print the <html>  tag, because it is the parent tag & parent element of <body>, here the parent element was present
