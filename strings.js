...
// console.log(last_name); // This will also print the old [last_name]
...
console.log(` My name ${my_name.endsWith("a") ? "ends" : "doew not ends"} with the letter "a"`);
console.log(` My name ${my_name.endsWith("a") ? "ends" : "doew not ends"} with the letter "b"`);
